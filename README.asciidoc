...
=== Programmation d'un ESP-01 sous espeasy
...
* le "Publish Template:" avec l'URL domogik pour le plugin vdevice de Domogik. Les variables "id" et "value" seront remplies en fonction du "device" déclaré sur l'ESP-01. 
